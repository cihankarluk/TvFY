    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(db_column='full_name', db_index=True, max_length=255)),
                ...
                ('perks', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(db_column='perks', max_length=32), null=True, size=None)),
                ...
                ('born_at', models.ForeignKey(db_column='born_at', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='a_born_at', to='country.country')),
                ('died_at', models.ForeignKey(db_column='died_at', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='a_died_at', to='country.country')),
            ],
            options={
                'abstract': False,
            },
