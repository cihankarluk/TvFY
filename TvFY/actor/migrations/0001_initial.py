    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(db_column="full_name", db_index=True, max_length=255),
                ),
                (
                    "imdb_url",
                    models.URLField(db_column="imdb_url", unique=True),
                ),
                (
                    "born_date",
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(db_column="perks", max_length=32),
                        null=True,
                        size=None,
                    ),
                ),
