    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(db_column='movie', on_delete=django.db.models.deletion.CASCADE, to='movies.movie', to_field='tvfy_code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_watched', models.BooleanField(db_column='is_watched')),
                ('is_going_to_watch', models.BooleanField(db_column='is_going_to_watch')),
                ('series', models.ForeignKey(db_column='series', on_delete=django.db.models.deletion.CASCADE, to='series.series', to_field='tvfy_code')),
                ('user', models.ForeignKey(db_column='user', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('watched_season', models.ForeignKey(db_column='watched_season', on_delete=django.db.models.deletion.CASCADE, to='series.season')),
            ],
            options={
