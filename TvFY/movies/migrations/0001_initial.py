    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rt_audience_count",
                    models.PositiveIntegerField(db_column="rt_audience_count", null=True),
                ),
                (
                    "rt_tomatometer_rate",
                ...
                (
                    ...
                    models.PositiveIntegerField(db_column="rt_tomatometer_count", null=True),
                ),
                (
                    "rotten_tomatoes_url",
                    models.URLField(
                        db_column="rotten_tomatoes_url",
                        db_index=True,
                        null=True,
                        unique=True,
                    ),
                ...
                (
                    "budget_amount",
                    models.PositiveIntegerField(db_column="budget_amount", null=True),
                ),
                (
                    "budget_currency",
                    models.CharField(db_column="budget_currency", max_length=3, null=True),
                ),
                (
                    "usa_ow_amount",
                    models.PositiveIntegerField(db_column="usa_ow_amount", null=True),
                ),
                (
                    "usa_ow_currency",
                    models.CharField(db_column="usa_ow_currency", max_length=3, null=True),
                ),
                (
                    "ww_amount",
                    models.PositiveIntegerField(db_column="ww_amount", null=True),
                ),
                (
                    "ww_currency",
                    models.CharField(db_column="ww_currency", max_length=3, null=True),
                ),
                (
                    "metacritic_score",
                ...
                (
                    "country",
                    models.ManyToManyField(db_column="country", to="country.country"),
                ),
                (
                    "director",
                    models.ForeignKey(
                ...
                (
                    "genres",
                    models.ManyToManyField(db_column="genres", to="genre.genre"),
                ),
                (
                    "language",
                    models.ManyToManyField(db_column="language", to="language.language"),
                ),
            ],
            options={
                "abstract": False,
