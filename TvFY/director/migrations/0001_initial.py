    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perks', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, db_column='perks', max_length=32), null=True, size=None)),
                ...
                ('born_at', models.ForeignKey(db_column='born_at', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='d_born_at', to='country.country')),
                ('died_at', models.ForeignKey(db_column='died_at', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='d_died_at', to='country.country')),
            ],
            options={
                'abstract': False,
            },
